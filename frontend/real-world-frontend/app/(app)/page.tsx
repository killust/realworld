    ...
    <>
      ...
      <div className="grid grid-cols-12 my-[50px]">
        ...
        <div className="md:col-span-8 col-span-10">
          <div onClick={() => router.push("/article")} className="grid grid-cols-12 gap-6 py-20 md:px-20 px-5 bg-[white] rounded-lg hover:cursor-pointer hover:bg-gray-50 transition-colors duration-1000 ease-in-out">
